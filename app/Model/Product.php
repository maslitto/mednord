...
class Product extends Model
{
    ...
    public function getMetadescriptionAttribute($value)
    {
        if(!empty($value)){
            ...
            return "На сайте компании «Нордлайн» вы можете приобрести товары из категории «".$categoryTitle."» по привлекательной цене. Характеристики, сертификаты. Доставка по всей России.";
        }
