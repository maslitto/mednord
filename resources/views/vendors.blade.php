...
<!-- BEGIN CONTENT -->
	...
	<main class="content">		
		...
		<div class="pageText">
			<div class="wrapper">
				<div class="text">
					<p class="quote">За годы работы у нас скопилось немало опыта в выборе поставщиков оборудования. В данном разделе Вы можете ознакомиться с информацией о тех производителях, с которыми мы сотрудничаем.</p>
				</div>
			</div>
			<div class="big-list">
